...
const CollectionFilter: React.FC = () => {
    const initialOptions: Option[] = [
        { label: 'Price: High to Low', value: 'PRICE', booleanValue: false, id: 'price_high' },
        { label: 'Price: Low to High', value: 'PRICE', booleanValue: true, id: 'price_low' },
        { label: 'Best selling', value: 'BEST_SELLING', booleanValue: true, id: 'best_selling' },
    ...
    const placeholderOption: Option = { label: 'SORT', value: '', booleanValue: false, id: 'sort' };
            ...
            {isOpen && (
                <ul className="options">
                    {initialOptions.map((option) => (
                        <Link to={updateURL(option)} key={option.id} style={{textDecoration:"none"}}>
                            <li
